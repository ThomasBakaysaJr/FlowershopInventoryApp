...
def execute_save(prod_name, final_price, uploaded_file, recipe_items, target_id=None):
...
def handle_save_click(prod_name, final_price, uploaded_file, recipe_items):
    ...
    if collision:
        ...
        # Standard Update
        execute_save(prod_name, final_price, uploaded_file, recipe_items, target_id=original_id)
    else:
        # Standard Create
        execute_save(prod_name, final_price, uploaded_file, recipe_items)

def render_overwrite_dialog(prod_name, final_price, uploaded_file, recipe_items):
    ...
    if st.session_state.get('confirm_overwrite'):
        ...
        with col_yes:
            if st.button("Yes, Overwrite"):
                ...
                execute_save(prod_name, final_price, uploaded_file, recipe_items, target_id=target_id)
